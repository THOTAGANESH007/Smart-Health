      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            View and manage all patient health information
          </p>
        </div>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex gap-2 mt-1">
                          ...
                          <span className="px-2 py-0.5 rounded-full text-xs font-semibold bg-white  text-pink-600 bg-opacity-20">
                            {patient.age || "N/A"} yrs
                          </span>
                        </div>
                      </div>
...
export default AllPatientsHealthCards;